                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        id="name"
                                        className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#C4A484] focus:ring-2 focus:ring-[#C4A484]/20 focus:outline-none transition-colors"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        id="message"
                                        rows={4}
                                        className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-[#C4A484] focus:ring-2 focus:ring-[#C4A484]/20 focus:outline-none transition-colors resize-none"
                                        placeholder="Your message"
                                    ></textarea>
                                </div>
                                <button
                                    type="submit"
                                    className="w-full px-8 py-3 bg-[#C4A484] text-white rounded-lg hover:bg-[#B39374] transition-all duration-300 font-medium"
                                >
                                    Send Message
                                </button>
                            </motion.form>
