            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-lg">
                <div className="flex flex-col items-center">
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        ...
                        <Link to="/login" className="font-medium text-[#C4A484] hover:text-[#B39374] transition-colors">
                            Sign in
                        </Link>
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-4">
                    ...
                    <div className="pt-4">
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-[#C4A484] hover:bg-[#B39374] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#C4A484] disabled:bg-[#C4A484]/50 disabled:cursor-not-allowed transition-colors"
                        >
                            {loading ? (
